...
?>
<h5>provider.ftd.plg Override</h5>
<?php if ($displayData['plg_params']->get('show_list', 1)) : ?>
<div class="ftd-container plg">
    <h3 class="ftd-headline"><img class="headline-logo" src="<?php echo 'http://www.food-trucks-deutschland.de/' . $displayData['items'][0]['image'];?>" alt="<?php echo $item['name'];?>" > <?php echo $displayData['items'][0]['name'] ?> - <?php echo JText::_('PLG_CONTENT_FTDAPI_HEADLINE');?></h3>
    <div id="ftd-summary">
        <ul>
    ...
    <div class="ftd-items">
        ...
        <div class="ftd-item media">
            <div class="media-body">
                ...
                <a id="<?php echo $item['tourid']; ?>" class="provider-truck plg"><?php echo $item['truck'];?></a>
                <?php else: ?>
                <?php echo $item['truck'];?>
                <?php endif; ?>
                <span class="boldify">
