...
?>
<h5>provider.ftd.mod Override</h5>
<?php if ($displayData['mod_params']->get('show_list', 1)) : ?>
<div class="ftd-container mod">
    <h3 class="ftd-headline"><img class="headline-logo" src="<?php echo 'http://www.food-trucks-deutschland.de/' . $displayData['items'][0]['image'];?>" alt="<?php echo $item['name'];?>" > <?php echo $displayData['items'][0]['name'] ?> - <?php echo JText::_('MOD_FTDAPI_HEADLINE');?></h3>
    <div id="ftd-summary">
        <ul>
    ...
    <div class="ftd-items">
        ...
        <div class="ftd-item media">
            <div class="media-body">
                ...
                <a id="<?php echo $item['tourid']; ?>" class="provider-truck mod"><?php echo $item['truck'];?></a>
                <?php else: ?>
                <?php echo $item['truck'];?>
                <?php endif; ?>
                <span class="boldify">
